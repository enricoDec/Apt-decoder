...
public class Plot {
	...
	public static class PlotOptions {
		...
		private Font titleFont = new Font("Arial", Font.PLAIN, 24);
		...
		private int defaultLegendSignSize = 15;
		private int legendSignSize = 15;
		...
		private Font labelFont = new Font("Arial", 0, 20);
